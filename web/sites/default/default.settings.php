...
$domain = getenv('DRUPAL_SLD');

$settings['hash_salt'] = getenv('DRUPAL_HASH_SALT');
$settings['config_sync_directory'] = getenv('DRUPAL_CONFIG_SYNC_PATH');
$settings['file_private_path'] = getenv('DRUPAL_PRIVATE_FILES_PATH');
$settings['file_public_base_url'] = getenv('DRUPAL_PUBLIC_FILES_BASE_URL');
